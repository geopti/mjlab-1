"""Debug visualization for ViserMujocoScene (arrows, ghosts, frames)."""
...
class ViserSceneDebugMixin:
  """Mixin providing debug visualization for ViserMujocoScene."""
  ...
  _scene_offset: np.ndarray
  _queued_arrows: list[tuple[np.ndarray, np.ndarray, tuple[float, ...], float]]
  ...
  _ghost_meshes: dict[int, dict[int, trimesh.Trimesh]]
  _arrow_shaft_mesh: trimesh.Trimesh | None
  _arrow_head_mesh: trimesh.Trimesh | None
