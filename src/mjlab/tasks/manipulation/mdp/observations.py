...
def ee_to_object_distance(
  ...
  """Distance vector from end effector to object in EE frame."""
  ...
  distance_vec_ee = quat_apply(quat_inv(ee_quat_w), distance_vec_w)
  return distance_vec_ee
...
def object_to_goal_distance(
  ...
  """Distance vector from object to goal in EE frame."""
